<%-- 
    Document   : lock
    Created on : 2013-12-22, 15:02:16
   ...
   <% if( session.getAttribute("loginUser")==null && session.getAttribute("loginManager")==null ) { %>
	...
	<div class="page-lock">
		...
		<div class="page-logo">
			...
			<img src="../media/image/logo1.jpg" alt="logo" />
		...
		<div class="page-body">
			...
			<img class="page-lock-img" src="../media/image/mm.jpg" alt="">

			<div class="page-lock-info">

			<% if(session.getAttribute("loginManager")==null && session.getAttribute("loginUser")!=null){%>
                                <font style="color:whitesmoke;font-weight: bold">
				...
				<span><em>Locked</em></span>
                                ...
                                <form action="lockReturnAction" namespace="/" method="POST" onSubmit="password.value=hex_md5(password.value)">
